    ...
    <div class="programmes">
        <div class="row">
            ...
            <div class="col-xs-12 col-md-12 text-center">
                <h4 style="color: blue"><%=catogoryName %></h4>
            </div>
            ...
            <div class="col-xs-12 col-md-6 text-center">
                ...
                <div class="col-xs-12 col-md-12 text-center">
                    <h4 style="color: chocolate"><u><%=sname %> </u></h4>
                </div>
                <%
                ...
                %>
                <div class="col-xs-12 col-md-12 text-center"><b><%=aby%> </b></div>
                <%
                                DataRow[] programenameset = dt.Select("School_name ='" + sname + "' AND Accredited_Bycol='" + aby + "'");

                                foreach (DataRow row1 in programenameset)
                                {%>
                <div class="col-xs-12 col-md-12 text-center"><%=row1["Programme_Name"]%><br />
                </div>
